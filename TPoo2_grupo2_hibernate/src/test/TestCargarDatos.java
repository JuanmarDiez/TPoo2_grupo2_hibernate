...
public class TestCargarDatos {
	public static void main(String[] args) {
		try {
			...
			TurnoAbm.getInstance().agregarTurnoYDetalle(25, 27, 6, 6, "Hablar con director del departamento", LocalDate.of(2025, 5, 8), LocalTime.of(11, 30), LocalTime.of(12, 0));
			TurnoAbm.getInstance().agregarTurnoYDetalle(26, 27, 6, 6, "Hablar con director del departamento", LocalDate.of(2025, 5, 9), LocalTime.of(10, 00), LocalTime.of(10, 30));
			TurnoAbm.getInstance().agregarTurnoYDetalle(25, 27, 6, 6, "Hablar con director del departamento", LocalDate.of(2025, 5, 12), LocalTime.of(10, 00), LocalTime.of(10, 30));
			TurnoAbm.getInstance().agregarTurnoYDetalle(25, 27, 6, 6, "Hablar con director del departamento", LocalDate.of(2025, 5, 15), LocalTime.of(12, 30), LocalTime.of(13, 00));
